...
cv2.createTrackbar("Hue min","trackbar",35,179,nothing)
cv2.createTrackbar("Hue max","trackbar",82,179,nothing)
cv2.createTrackbar("saturation min","trackbar",100,255,nothing)
cv2.createTrackbar("saturation max","trackbar",252,255,nothing)
cv2.createTrackbar("value min","trackbar",102,255,nothing)
...
while True:
    ...
    colimg=cv2.bitwise_and(img,img,mask=mask)
    cv2.imshow("coloured one",colimg)
